package com.harshit.homeharbor.adapters;
...
import com.harshit.homeharbor.activities.NavDetailedActivity;
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra("navdetail", list.get(holder.getAdapterPosition()));
